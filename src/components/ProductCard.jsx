...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="sm:max-w-sm bg-white rounded-2xl shadow-lg border border-gray-300 overflow-hidden flex flex-col h-[450px]">
      ...
      {/* Bottom Section */}
      <div className="p-5">
        <h2 className="text-lg font-bold text-orange-500 truncate">
          {product.title}
        </h2>
        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          <button
            className="bg-orange-600 text-white px-4 py-2 rounded-lg font-semibold shadow-md hover:bg-orange-500 cursor-pointer"
